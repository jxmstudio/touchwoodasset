...
export function OwnerPromo({ className = '', variant = 'card' }: OwnerPromoProps) {
  if (variant === 'strip') {
    return (
      <FadeIn>
        <section className={`relative overflow-hidden rounded-xl bg-gradient-to-r from-brand-50 to-white border border-brand-50/50 ${className}`}>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="flex-1">
                ...
                <p className="text-muted-foreground text-sm md:text-base">
                  $500 for new management transfers, plus $100 for storage and carpark rentals.*
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                >
                  <a href="/landlords" aria-label="Learn more about property management services">
                    Learn more
                  </a>
                </Button>
                ...
                >
                  <a href="/book" aria-label="Book a consultation for property management">
                    Book consultation
                  </a>
                </Button>
              </div>
  ...
  return (
    <FadeIn>
      <Card className={`relative overflow-hidden shadow-soft-lg border-0 bg-white ${className}`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            ...
            <div className="relative h-64 lg:h-auto bg-gradient-to-br from-brand-50/30 to-white/90">
              <div className="absolute inset-0 p-8 lg:p-12 hidden md:flex items-center justify-center">
                <div className="relative w-44 h-44 lg:w-60 lg:h-60 rounded-xl overflow-hidden bg-white ring-1 ring-gray-200 shadow-sm">
                  <Image
                    src="/Bricksy.png"
                    alt="Bricksy mascot thumbnail"
                    fill
                    className="object-cover saturate-80 contrast-95 brightness-100"
