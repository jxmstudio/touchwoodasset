...
export const metadata: Metadata = {
  ...
  description: 'Privacy Policy for Touchwood Asset Management website and services.',
}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-gray-600">
            ...
            <a href="mailto:privacy@touchwood.com.au" className="text-blue-600 hover:underline">
              privacy@touchwood.com.au
            </a>
          </p>
        </div>
      </div>
